...
class Port(object):
    ...
    def connect(self, dest=None, name=None, id='', props={}):
        ...
        @param dest The destination Port object. Must be provided.
...
class CorbaPort(Port):
    ...
    def connect(self, dest=None, name=None, id='', props={}):
        ...
        with self._mutex:
            ...
            super(CorbaPort, self).connect(dest=dest, name=name, id=id,
                                           props=new_props)
